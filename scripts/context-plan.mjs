...
const ROUTES = [
  ...
  },
  {
    ...
    docs: ['docs/ASTRA_OUTCOME_CONTRACT.md', 'docs/DEVELOPMENT.md'],
  },
  {
    ...
    docs: ['docs/ASTRA_OUTCOME_CONTRACT.md', 'docs/DEVELOPMENT.md', 'docs/INTEGRATION.md', 'docs/RINNE_PROJECT_EXECUTION_POLICY.md'],
  },
  {
