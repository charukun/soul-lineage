...
run('python3',['scripts/character-forge/record_visual_rejection.py','--workspace',workspace,'--cache',cache,'--review','scripts/character-forge/fixtures/upstream-scout-material-r6-review.json']);
...
// The actual r6 review requests refine-spec: regenerate only through pinned upstream.
run('python3',['scripts/character-forge/refine_scout_hair_opening.py','--workspace',workspace,'--cache',cache]);
...
run('python3',['packages/assets/forge/upstream_workspace.py','mark','--workspace',workspace,'--','build-current-pass','--evidence','build/material-pass.ts','--evidence','img2threejs/evidence/side-hair-width-refinement.json']);
