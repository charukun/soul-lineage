...
run('python3',['scripts/character-forge/validate_scout_dcc_checkpoint.py','--workspace',workspace]);
...
// Resume the actual packed Blender result; raw audit is scoped before rigging.
