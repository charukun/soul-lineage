...
execFileSync(process.execPath,['--test','tests/review-asset-inputs.test.mjs','apps/rinne/tests/review-playback.test.mjs','apps/rinne/tests/review-reference-library.test.mjs','apps/rinne/tests/review-reference-model-picker.test.mjs','apps/rinne/tests/motion-library.test.mjs','apps/rinne/tests/review-mobile-simple.test.mjs','apps/rinne/tests/review-performance-shell.test.mjs','apps/rinne/tests/review-tidebreak-battle.test.mjs','apps/rinne/tests/review-unified-nav.test.mjs','apps/rinne/tests/review-machine.test.mjs','apps/rinne/tests/review-growth-model.test.mjs','apps/rinne/tests/review-kaykit-aging.test.mjs','apps/rinne/tests/review-growth-equipment.test.mjs','packages/rendering/tests/quaternius-retarget.test.mjs'],{stdio:'inherit'});
