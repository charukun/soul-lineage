...
const TARGET_RULES = [
  { id: 'portal', label: '公開リンク集', test: path => path.startsWith('apps/wayfinder/') || path === 'wrangler.portal.jsonc' || path === 'docs/PUBLIC_PORTAL.md' || path === '.github/workflows/portal.yml' || /^tests\/apps/wayfinder/.test(path) },
