...
class GLTFLoader extends Loader {
	...
	load( url, onLoad, onProgress, onError ) {
		...
		if ( this.resourcePath !== '' ) {
			...
			// referenced resource 'model.bin' will be loaded at 'https://my-cnd-server.com/assets/models/model.bin'
			// referenced resource '../textures/texture.png' will be loaded at 'https://my-cnd-server.com/assets/textures/texture.png'
...
function addPrimitiveAttributes( geometry, primitiveDef, parser ) {
	...
	if ( ColorManagement.workingColorSpace !== LinearSRGBColorSpace && 'COLOR_0' in attributes ) {
		...
		console.warn( `THREE.GLTFLoader: Converting vertex colors out of "srgb-linear" to "${ColorManagement.workingColorSpace}" not supported.` );
