...
function hud(now){
 if(!game)return;
 const p=game.player,al=game.alarm,ui=huntUiState(game,{returning:returnMode}),groupCount=ui.fight?(game.combatantCount?.()||1):0;let hp=Math.max(0,p.hp);
