...
async function install(view,generation){
  ...
  for(const row of rows){if(row.status==='fulfilled')group.add(row.value);else console.warn('[宝満叡智] Nature visual fallback',row.reason);}
...
window.__宝満叡智_NATURE__=Object.freeze({
