...
test('village installs visual scale before fixed simulation scale and game boot',()=>{
 assert.ok(main.indexOf("./authored-visual-lod.js")<main.indexOf("./stylized-visual-target.js"));assert.ok(main.indexOf("./stylized-visual-target.js")<main.indexOf("./adaptive-visual-performance.js"));assert.ok(main.indexOf("./adaptive-visual-performance.js")<main.indexOf("./runtime-resilience.js"));assert.ok(main.indexOf("./runtime-resilience.js")<main.indexOf("./shared-world-scale.js"));assert.ok(main.indexOf("./shared-world-scale.js")<main.indexOf("./simulation-scale.js"));assert.ok(main.indexOf("./simulation-scale.js")<main.indexOf("./web/main.js"));
});
