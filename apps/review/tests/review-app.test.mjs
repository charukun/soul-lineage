...
test('Lab separates equipment and world-object probes and routes them to delivered runtimes',()=>{
  ...
  assert.match(source,/const warmQueue=/);assert.match(source,/ROUTES\.effects/);assert.match(source,/effekseer\\.wasm/);assert.match(source,/Simple_Ribbon_Sword\\.efkefc/);assert.match(source,/ToonHit\\.efkefc/);
