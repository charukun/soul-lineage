...
test('battle2 body HUD stays compact and opens one six-part durability list',()=>{
 ...
 assert.match(css,/grid-template-columns:28px minmax\(0,1fr\)!important/);assert.match(css,/battle2-body-hud__gauge>span/);assert.match(css,/data-hit=true/);assert.match(version,/BATTLE2_VERSION='2\.2\.36'/);
});
