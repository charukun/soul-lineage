...
export function createJohakyuP7Controller({world,effects,stage,sound,notify,signal,onMeta=()=>{},evidence=false,fixture=null,mode='duel'}){
  ...
  const scenario=evidence&&fixture==='parry'?createJohakyuP7ReviewScenario({mode,duelGap:2.4,heroStartPhase:'kyu',heroStartTechniqueIndex:0,enemyLeadSeconds:.5}):createJohakyuP7ReviewScenario({mode,comboStyle:'burst',duelGap:mode==='duel'?2.18:3.15,enemyLeadSeconds:mode==='duel'?.16:0});
