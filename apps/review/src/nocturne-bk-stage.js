const stage=document.querySelector('[data-review-surface="battlebk"]');
const status=document.getElementById('battlebk-status');
...
window.__BATTLEBK__=Object.freeze({
...
async function boot(){
  ...
  try{
    const [{createBattleRuntime},{createNocturneSound}]=await Promise.all([import('./nocturne-bk/runtime.js'),import('./nocturne-bk/audio.js')]);
