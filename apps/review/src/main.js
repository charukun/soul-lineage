...
const ROUTES=Object.freeze({...createReviewRoutes({rinneBase:DEV.rinne,charactersBase:DEV.characters}),equipment:route(DEV.rinne,'review-assets.html'),objects:route(DEV.rinne,'review-objects.html'),sounds:route(DEV.rinne,'review-sound.html'),rinne:DEV.rinne,village:DEV.village,demon:DEV.demon,pulse:DEV.pulse});
