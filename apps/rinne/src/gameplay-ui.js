...
export function createGameplayUI(gameScreen,{stations,layout,audio,requestEquip}){
  ...
  const q=s=>root.querySelector(s),panel=q('[data-panel]'),ui={
    root,dash,
    heart:q('[data-heart]'),techniques:q('[data-techniques]'),bodyButton:q('.rinne-bottom-controls [data-body]'),items:q('[data-items]'),map:q('[data-map]'),record:q('[data-record]'),phase:q('[data-phase]'),
