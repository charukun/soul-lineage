export function installReviewUX({reviewPresets,reviewWeapons}){
  ...
  style.textContent=`
    ...
    .review-reference-link{pointer-events:auto;display:inline-flex;align-items:center;justify-content:center;min-height:30px;padding:0 10px;border:1px solid #ffffff1f;border-radius:999px;background:#0b0f14c9;color:#dfff9f;text-decoration:none;font-size:9px;font-weight:800;letter-spacing:.03em;backdrop-filter:blur(12px)}.review-reference-link:active{transform:scale(.97)}
