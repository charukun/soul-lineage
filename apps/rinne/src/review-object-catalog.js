...
const REVIEW_PROP_IDS=Object.freeze(['fence','wall','tree','pine','flowers','hedge','lamp','bench','wardlamp','bed','sofa','table','chair','shelf','counter','workbench','hearth','rug','plant']);
...
export const RINNE_OBJECT_REVIEW_CATALOG=Object.freeze([
  ...
  ...REVIEW_PROP_IDS.map(id=>({id:`prop-${id}`,label:defs[id]?.label||id,kind:'prop',propKind:id,source:'RINNE shared world runtime'})),
