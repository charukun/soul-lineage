...
export function createRinneBirthVillage(){
  return validateMuraLayout({
    ...
    objects:[
      ...
      building('birth-home-west','home',-22,9,.04,[['bed',-1.4,-1.8],['table',1,0],['shelf',1.8,-2],['plant',-1.8,2],['lamp',1.8,2]]),
      building('birth-home-southwest','home',-24,-10,-.04,[['bed',-1.4,-1.8],['sofa',1.2,.8],['table',-.8,1.8],['hearth',1.6,-2],['rug',0,0]]),
      building('birth-lodge','lodge',-32,0,.03,[['bed',-2.5,-2.8],['bed',2.5,-2.8],['table',0,0],['shelf',-2.8,3],['sofa',2.3,2.5],['lamp',0,-3.8]]),
      building('birth-inn','inn',-13,-19,.02,[['bed',-2.5,-2.8],['bed',2.5,-2.8],['sofa',0,2.2],['hearth',-2.8,3],['rug',2,3],['lamp',2.8,3]]),
      ...
      building('birth-clinic','clinic',14,-3,-.02,[['bed',-1.8,-1.5],['bed',1.6,-1.5],['table',0,1.5],['plant',2.4,1.8],['shelf',-2.5,2]]),
      building('birth-guardpost','guardpost',0,-17,Math.PI,[['bench',-1.4,.8],['table',1.2,.8],['shelf',-1.6,-1.5],['lamp',1.7,-1.5]]),
      building('birth-barracks','barracks',9,-26,.02,[['bed',-2.5,-2.5],['bed',2.5,-2.5],['bench',0,1.8],['table',0,-.5],['lamp',3.2,3.2]]),
      building('birth-weapons','weapons',23,-12,.03,[['counter',0,-1.5],['workbench',-1.8,.6],['shelf',1.8,.8],['lamp',0,2.3]]),
      ...
      object('birth-watch-east','watchtower',18,-27,0),
