...
export const SUPPORT_SKILLS=Object.freeze([
  ...
  {id:'skill.repeat',name:'反復',type:'support',needs:['repeat'],threshold:.65,effects:{trainingGain:.24,actionSpark:.08}},
  {id:'skill.distance',name:'間合い',type:'support',needs:['distance'],threshold:.65,effects:{reach:.08,actionSpark:.08}},
  {id:'skill.adapt',name:'環境適応',type:'support',needs:['adapt'],threshold:.65,effects:{mitigation:.04,staminaCost:-.03}},
  {id:'skill.rhythm',name:'拍子',type:'support',needs:['play','repeat'],threshold:.8,effects:{actionSpark:.08,staminaCost:-.03}},
