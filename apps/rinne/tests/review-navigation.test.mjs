...
test('all Visual Review specialist pages receive the shared navigation module',async()=>{
  ...
  for(const page of ['/characters.html','/characters-advanced.html','/review-motion.html','/review-assets.html','/review-effects.html','/review-battle.html'])assert.match(entries,new RegExp(`'${page.replaceAll('.','\\.')}'`));
