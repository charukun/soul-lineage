...
function combatState(seed=41){
  ...
  state.combatLoadout={heart:{active:['skill.read','skill.patience']},technique:{activeComboId:'combo-1',combos:[{id:'combo-1',name:'試験連技',slots:{jo:'action.counter',ha:'basic.sword',kyu:'action.finish'},favored:{}}],oneMotion:null},body:{stance:'seigan',finisher:'kaishaku',zanshin:'still'}};
  return state;
}
