...
const compact={
  ...
  theory:{pass:report.theory.pass,boundaries:report.theory.boundaries,packetInterleavings:report.theory.packets.interleavings.cases.length,quorumRows:report.theory.packets.generalized.rows.map(row=>({failures:row.failures,members:row.members,quorum:row.quorum,minIntersection:row.minIntersection,minSurvivingCopies:row.minSurvivingCopies})),finiteBurstCases:report.theory.packets.faults.burstCases.length,denseRelay:{starFanout:report.theory.relay.dense.star.maxSenderFanout,r1:{relays:report.theory.relay.dense.r1.relays,maxSenderFanout:report.theory.relay.dense.r1.maxSenderFanout,aggregateTransmissions:report.theory.relay.dense.r1.aggregateTransmissions},r2:{relays:report.theory.relay.dense.r2.relays,maxSenderFanout:report.theory.relay.dense.r2.maxSenderFanout,aggregateTransmissions:report.theory.relay.dense.r2.aggregateTransmissions,oneRelayFailureSafe:report.theory.relay.dense.r2Failure.pass}}},
