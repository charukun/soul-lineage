...
export const SLASH_REVISION = 'shino-slash-10';
...
const body = {
  ...
  hips:[[0,0,0,0],[.23,-.10,-.58,-.07],[.34,-.15,-.60,-.08],[.44,-.24,.04,-.06],[.50,-.40,.46,-.045],[.62,-.19,.85,.075],[.76,-.10,.66,.045],[.86,-.07,.40,.025],[1,0,0,0]],
  spine:[[0,0,0,0],[.28,.045,-.21,.085],[.38,.025,-.25,.055],[.46,-.05,-.18,.015],[.50,-.29,.12,-.10],[.62,-.14,.26,-.09],[.80,-.03,.13,-.035],[1,0,0,0]],
  chest:[[0,0,0,0],[.30,.055,-.14,.06],[.40,.025,-.17,.045],[.46,-.02,-.13,.015],[.50,-.14,.03,-.07],[.57,-.16,.10,-.075],[.66,-.09,.26,-.06],[.80,-.02,.10,-.025],[1,0,0,0]],
  head:[[0,0,0,0],[.34,-.015,.46,0],[.50,.085,-.29,.045],[.66,.05,-.56,.035],[.82,.02,-.23,0],[1,0,0,0]],
  offset:[[0,0,-.028,0],[.22,-.15,-.255,-.075],[.34,-.14,-.285,-.015],[.47,.10,-.245,.27],[.56,.14,-.22,.34],[.70,.12,-.17,.33],[.84,.055,-.12,.19],[1,0,-.028,0]],
