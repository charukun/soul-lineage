...
export const SLASH_REVISION = 'shino-slash-7';
...
const body = {
  ...
  blade:[[0,.398,1.15,0],[.25,-2.10,.36,-.36],[.38,-2.22,.28,-.46],[.44,-1.90,.20,-.39],[.50,0,.02,-.15],[.59,1.58,-.33,.27],[.72,2.02,-.42,.42],[.84,1.45,.35,.32],[1,.398,1.15,0]],
