...
export const SLASH_REVISION = 'shino-slash-12';
...
const body = {
  ...
  hips:[[0,0,0,0],[.23,-.10,-.64,-.10],[.34,-.15,-.68,-.11],[.44,-.24,.04,-.06],[.50,-.40,.46,-.045],[.62,-.19,.98,.11],[.76,-.10,.72,.07],[.86,-.07,.40,.025],[1,0,0,0]],
  spine:[[0,0,0,0],[.28,.045,-.21,.085],[.38,.025,-.25,.055],[.46,-.05,-.18,.015],[.50,-.29,.12,-.10],[.62,-.14,.26,-.09],[.80,-.03,.13,-.035],[1,0,0,0]],
  chest:[[0,0,0,0],[.30,.055,-.18,.10],[.40,.025,-.21,.08],[.46,-.02,-.13,.015],[.50,-.14,.03,-.07],[.57,-.18,.10,-.11],[.68,-.11,.32,-.10],[.80,-.02,.10,-.025],[1,0,0,0]],
