...
- 序破急HUDは主人公視点のExchangeに追従する。守勢・読み合い・strong parry直後のreversal/counter移行中は左端の間合い波形とし、主人公が新たにinitiativeを得た後の通常攻勢は必ず序から開始して破→急へ進む。主人公自身が急まで完遂した時だけ右端の残心を点灯し、相手側の攻勢完了では左端へ戻る。攻守交代前のcursor phaseをそのままHUDへ持ち越さない。
