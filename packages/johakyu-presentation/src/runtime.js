...
const game = {phase:'loading',time:0,wave:0,spawned:0,waveCount:0,spawnTimer:0,kills:0,damage:0,received:0,bursts:0,stance:'balanced',speed:1,energy:0,level:1,upgradeTime:0,banner:0,toast:0,shake:0,hitstop:0,cameraPunch:0,cameraImpulseX:0,cameraImpulseZ:0,cameraFocusX:0,cameraFocusZ:0,ready:false,pausedFrom:'battle',high:stage.clientWidth>720,moveTarget:null,moveTime:0};
...
function start(){
 ...
 rules?.reset();rounds++;Object.assign(game,{phase:'battle',time:0,wave:0,kills:0,damage:0,received:0,bursts:0,energy:0,level:1,moveTarget:null,moveTime:0,boss:null,shake:0,hitstop:0,cameraPunch:0,cameraImpulseX:0,cameraImpulseZ:0,cameraFocusX:0,cameraFocusZ:0,resetSeconds:0});
...
function renderCamera(dt){
 ...
 const desired=isTitle?new V(-2,.6,0):motionCamera?hero.pos.clone().add(new V(0,motionCamera.shot.focusHeight,0)):midpoint.add(new V(0,.65,-.35));desired.x+=game.cameraFocusX;desired.z+=game.cameraFocusZ;
