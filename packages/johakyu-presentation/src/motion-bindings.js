import {resolveJohakyuMotion as resolveCombatMotion} from '@soul/johakyu-combat/motion-contract';
...
export function resolveJohakyuMotion({weapon,kind,charge='none',phase='jo',availableClips=null}={}){
  ...
  const authored=resolveCombatMotion({weapon,kind,charge,phase});
