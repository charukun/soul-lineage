...
export const BUILDINGS=[
 ...
 f('quarry','石切場',10,9,{shape:'yard',produce:{stone:4,ore:1},terrain:'rock',roof:0x9c9da1,trait:'露岩から石と鉄鉱石。2段階目から輝石も採れます。'}),
 f('carpenter','木工所',7,6,{input:{wood:2},produce:{plank:4},unlock:['wood'],roof:0xb59b6f,trait:'丸太を板材へ加工。家や見張り台の建材になります。'}),
 f('wheat','小麦畑',10,10,{shape:'field',open:true,terrain:'fertile',produce:{food:6,seed:1},roof:0xccb16f,trait:'肥沃な土で小麦を育てます。食料と種、移住者を迎える余裕+4。'}),
 f('clay','泥採集場',8,7,{shape:'yard',terrain:'wetland',produce:{clay:4},roof:0xa78676,trait:'湿地や水辺の粘土を採集。土壁の家にも使えます。'}),
 f('market','市場',10,8,{shape:'market',effect:'market',produce:{cloth:1,herb:1},input:{food:1},roof:0xc49289,trait:'4日ごとに旅商人が2日間滞在。食料と交換で布・薬草を入手。住人は小物や家具を買います。'}),
 f('home','空き家',6,7,{capacity:3,jobs:0,category:'住まい',roof:0xbc7e62,unlock:['wood'],cost:{wood:12,plank:8,stone:6},variants:true,interiorClass:'standard',doorWidth:1.8,trait:'3人の家。建材を選べ、増築で定員と快適さが増します。'}),
 f('lodge','大きな空き家',9,10,{capacity:6,jobs:0,category:'住まい',floors:2,roof:0x77988a,unlock:['plank','stone'],cost:{wood:24,plank:16,stone:12},variants:true,interiorClass:'large',doorWidth:2.1,trait:'6人の共同住宅。村の食料と警備に余裕をつくってから。'}),
 f('clanManor','一族の邸宅',12,14,{capacity:4,jobs:0,category:'住まい',floors:2,roof:0x858ab0,clanOnly:true,unlock:['plank','stone','cloth'],cost:{wood:28,plank:32,stone:24,cloth:8},variants:true,interiorClass:'large',doorWidth:2.4,trait:'百年転生の一族プレイヤー専用。一般NPCは自動入居しません。各人の家具と一族情報を保持します。'}),
 f('guardpost','詰所',6,6,{category:'守り',roof:0x829ca5,jobs:1,unlock:['wood'],cost:{wood:8},effect:'guard',defense:5,trait:'住人1人が警備職に就きます。就労後は周辺を巡回し、移住者の安心枠+5。'}),
 f('watchtower','見張り台',5,5,{category:'守り',floors:2,jobs:1,roof:0x7d9196,unlock:['plank'],cost:{wood:12,plank:8},effect:'watch',defense:4,trait:'近隣30mの見張り。警備員の迎撃に加え、脅威の早期発見と安心枠+4。'}),
 f('barracks','駐屯所',10,10,{category:'守り',floors:2,jobs:3,cost:{wood:22,stone:25,plank:20},unlock:['plank','stone'],effect:'guard',defense:10,roof:0x8b8f9e,trait:'警備職3人の拠点。巡回と救助を行い、移住者の安心枠+10。'}),
 f('chapel','教会',9,12,{cost:{stone:30,plank:18,clay:12},unlock:['stone','clay','plank'],effect:'comfort',produce:{charm:1},input:{knowledge:1},roof:0xa59cbe,trait:'日々の安心を高め、学んだ知恵をお守りにします。'}),
 f('harbor','船着き場',12,10,{cost:{wood:30,plank:30,stone:15},unlock:['plank','stone'],effect:'harbor',terrain:'coast',roof:0x879bad,trait:'東海岸の港。5年ごとに巨大帆船が寄港し、布と薬草を届けて魔王軍戦線へ出港します。'}),
 f('smith','鍛冶屋',7,7,{cost:{stone:22,plank:12,clay:8},unlock:['ore','plank'],input:{ore:2,wood:1},produce:{metal:2},effect:'tools',roof:0xa57a63,trait:'鉄鉱石を鉄材へ。金属を使う武具や設備が利用可能になります。'}),
 f('dojo','道場',10,9,{category:'守り',cost:{wood:20,plank:20,stone:8},unlock:['plank'],effect:'training',produce:{knowledge:1},roof:0x927e72,trait:'心身を鍛え、村の護衛の攻撃力を底上げします。知恵も蓄えます。'}),
 f('school','学校',10,9,{cost:{wood:18,plank:20,clay:8},unlock:['plank','clay'],effect:'learning',produce:{knowledge:2},roof:0x9aaa7c,trait:'読み書きと仕事を学ぶ場所。知恵を生み、住人の技能が育ちます。'}),
 f('clinic','治療所',8,8,{cost:{wood:14,plank:14,stone:10},unlock:['herb','plank'],effect:'healing',input:{herb:1},produce:{medicine:2},roof:0x9aacbb,trait:'薬草から薬を作り、負傷者を救助・治療します。'}),
 f('farm','農園',12,14,{shape:'estate',terrain:'fertile',cost:{wood:16,stone:8,plank:10},unlock:['seed','plank'],produce:{food:14,herb:1},roof:0x9aab7b,trait:'豊かな土で食料と薬草を栽培。食事の余裕+8。'}),
 f('fishpond','釣り堀',10,10,{shape:'pond',open:true,terrain:'water',cost:{stone:20,wood:12,clay:12},unlock:['clay','stone'],produce:{food:10},roof:0x8daca5,trait:'水辺に作る釣り場。食料を得て、住人が釣りを楽しみます。'}),
 f('hunting','猟場',12,12,{shape:'yard',terrain:'forest',cost:{wood:14,stone:6,plank:8},unlock:['plank'],produce:{food:9,leather:2},roof:0x7a8976,trait:'森で食料と革を集めます。警備の届く位置なら野生動物からも安心。'}),
 f('orchard','果樹園',12,14,{shape:'orchard',open:true,terrain:'fertile',cost:{wood:14,stone:8,plank:6},unlock:['seed','plank'],produce:{food:12,herb:1},roof:0xa6b780,trait:'実りと薬草の庭。住人が実を摘み、木陰で休みます。'}),
 f('inn','宿屋',9,10,{floors:2,cost:{wood:24,stone:12,plank:22},unlock:['plank','cloth'],effect:'rest',roof:0xa57979,trait:'疲れを癒やす宿。休息の回復量が増え、村の魅力も高まります。'}),
 f('diner','食堂',8,8,{cost:{wood:14,plank:12,clay:8},unlock:['food','plank'],effect:'meal',roof:0xc3a174,trait:'住人が集まって食事。満腹度と気分の回復が増します。'}),
 f('restaurant','料亭',10,9,{cost:{wood:22,plank:28,stone:16,clay:10},unlock:['food','herb','cloth'],effect:'feast',roof:0x929e87,trait:'薬草と食料があれば、時折ごちそうの集いを開きます。'}),
 f('weapons','武器屋',7,7,{category:'守り',cost:{wood:12,metal:8,plank:14},unlock:['metal'],input:{metal:1,plank:1},produce:{gear:1},effect:'equipment',roof:0x9e8476,trait:'鉄と板材から武具を生産。備蓄した武具は護衛の強さに反映されます。'}),
 f('armor','防具屋',7,7,{category:'守り',cost:{wood:14,metal:6,plank:14},unlock:['metal','leather'],input:{leather:1,metal:1},produce:{gear:2},effect:'equipment',roof:0x7d94a0,trait:'革と鉄で防具を作り、警備職を支えます。'}),
 f('jeweler','装飾工房',7,7,{cost:{wood:12,stone:14,plank:18,metal:4},unlock:['crystal','metal'],input:{crystal:1},produce:{charm:2},effect:'craft',roof:0xb093b0,trait:'輝石をお守りへ。装飾と魔除けの灯りに使えます。'}),
 f('tools','道具屋',7,7,{cost:{wood:14,plank:12,stone:8},unlock:['metal'],input:{wood:1,metal:1},produce:{gear:1},effect:'tools',roof:0xb09f76,trait:'道具の手入れと製作。採集・生産の効率を上げます。'}),
...
export const FURNITURE=[
 {id:'bed',label:'ベッド',w:1.6,d:2.3,minInteriorClass:'compact'},{id:'sofa',label:'ソファ',w:2.05,d:.95,minInteriorClass:'standard'},
 {id:'table',label:'食卓',w:1.45,d:.95,minInteriorClass:'compact'},{id:'chair',label:'椅子',w:.65,d:.65,minInteriorClass:'compact'},
 {id:'shelf',label:'本棚',w:1.35,d:.45,minInteriorClass:'compact'},{id:'counter',label:'カウンター',w:1.9,d:.75,minInteriorClass:'large'},
 {id:'workbench',label:'作業台',w:1.75,d:.85,minInteriorClass:'large'},{id:'hearth',label:'暖炉',w:1.35,d:.75,minInteriorClass:'standard'},
 {id:'rug',label:'絨毯',w:2.1,d:1.5,soft:true,minInteriorClass:'compact'},{id:'plant',label:'鉢植え',w:.7,d:.7,minInteriorClass:'compact'},
 {id:'lamp',label:'灯り',w:.6,d:.6,minInteriorClass:'compact'},{id:'bench',label:'ベンチ',w:1.6,d:.75,minInteriorClass:'compact'}
