...
export const BUILDINGS=[
 ...
 f('carpenter','木工所',7,6,{shape:'tent',input:{wood:2},produce:{plank:4},unlock:['wood'],roof:0xb59b6f,trait:'丸太を板材へ加工。家や見張り台の建材になります。'}),
 ...
 f('guardpost','詰所',6,6,{shape:'tent',category:'守り',roof:0x829ca5,jobs:1,unlock:['wood'],cost:{wood:8},effect:'guard',defense:5,trait:'住人1人が警備職に就きます。就労後は周辺を巡回し、移住者の安心枠+5。'}),
