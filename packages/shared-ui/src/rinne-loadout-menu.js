...
export function createRinneLoadoutSlotRow({swapMode=false,documentRef=document}={}){const node=documentRef.createElement('section');node.className='loadout-slot-row';node.dataset.swapMode=String(swapMode);return node;}
