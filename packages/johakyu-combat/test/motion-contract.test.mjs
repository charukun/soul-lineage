...
import {compileJohakyuCatalogTrial,resolveJohakyuMotion} from '../src/motion-contract.js';
const manifest=JSON.parse(readFileSync(new URL('../../../apps/review/src/nocturne/manifest.json',import.meta.url)));
