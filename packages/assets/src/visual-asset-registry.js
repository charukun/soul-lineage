...
export const visualAssetRegistry=Object.freeze({
 'village.yurt.authored-royal-xion.v3':materialized({
   ...
   source:{repository:'JustusAvramenko/delenda_est',revision:'7f1ed21fe909f3584b96ddcb874645fe3fe3776e',path:'art/meshes/structural/xion_royal_yurt.dae',hash:'git-blob:f045bf6b43c093827653fd6f570d86193a1e376a'},
   runtime:{format:'compiled-collada',yaw:0,maxHeight:3.6},meshData:DELENDA_XION_ROYAL_YURT
 }),
