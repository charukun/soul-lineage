def create_rig(spec):
    ...
    for side in ('L','R'):
        ...
        arm=comps['upperArm.'+side]['rings'][-1]['cx']
        leg=comps['upperLeg.'+side]['rings'][-1]['cx']
        add('shoulder.'+side,'chest',[arm*.6,levels['shoulder'],0])
        add('upperArm.'+side,'shoulder.'+side,[arm,levels['shoulder'],0]);add('lowerArm.'+side,'upperArm.'+side,[comps['lowerArm.'+side]['rings'][-1]['cx'],.54,0]);add('hand.'+side,'lowerArm.'+side,[comps['hand.'+side]['rings'][-1]['cx'],.39,0])
        add('upperLeg.'+side,'hips',[leg,.45,0]);add('lowerLeg.'+side,'upperLeg.'+side,[comps['lowerLeg.'+side]['rings'][-1]['cx'],.26,0]);add('foot.'+side,'lowerLeg.'+side,[comps['foot.'+side]['rings'][-1]['cx'],.055,0])
