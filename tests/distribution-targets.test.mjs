...
test('DEV distribution plan is app-scoped and fans shared dependencies out through workspace closure',()=>{
  ...
  assert.deepEqual(shared.apps,['character-studio','demon','review','rinne','village']);
  ...
  assert.deepEqual(distributionPlanForDev(nodes,['AGENTS.md','.autonomous/README.md','.task-start/session.json','scripts/distribution-plan.mjs']),{apps:[],include:[]});
