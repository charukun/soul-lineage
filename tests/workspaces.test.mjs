...
import { graph, apps, affected, closure, inputHash } from '../scripts/workspaces.mjs';
const nodes = graph();
...
test('unused packages do not build unrelated games', () => assert.deepEqual(affected(nodes, ['packages/audio/src/index.js']), []));
