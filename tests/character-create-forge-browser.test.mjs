...
test('Character Forge shipped GLB and reference comparisons in its dedicated Review Lab view',{timeout:420000},()=>{
  ...
  execFileSync('npm',['run','build','--workspace','@soul/review'],{stdio:'inherit',timeout:120000});
