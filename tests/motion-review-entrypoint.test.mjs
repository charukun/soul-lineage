...
const workshopPath = new URL('../apps/character-studio/index.html', import.meta.url);
const legacyPath = new URL('../apps/rinne/public/simulator/motion-review.html', import.meta.url);
const entrypointPath = new URL('../apps/character-studio/src/motion-review-entrypoint.js', import.meta.url);
