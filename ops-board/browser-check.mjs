...
const fixture = {
  ...
  applications: ['rinne','village','demon','portal','ops-board','visual-review'].map((id,i) => ({ id, name: ['百年転生','宝満叡智','魔物側','WAYFINDER','開発状況ボード','Visual Review Lab'][i], kind: i < 3 ? 'game' : 'tool', targets: [{ id, label: '開発版', state: i === 3 ? 'unknown' : 'success', commit: 'a'.repeat(40), deployedAt: rawDate, url: base, source: '検証データ' }] })),
