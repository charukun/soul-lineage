...
function render(view){
  ...
  root.append(node('p','rs-note','Draft作成時刻をRepository上の実装開始基準として計測。Validated Virtual TrainやStack-native CIは検証の重複を減らしますが、個別PRのreview/check/merge直前再確認とDEV gateは省略しません。'));
}
