...
Hero, enemy, interaction-critical and explicitly protected objects are never eligible. 宝満叡智 remains conservative and only opts explicit/set-dressing roots into this path; 喰滅廻遊 can use it for non-critical environment chunks.
