...
- RINNE object/sound review: 23 curated Kenney CC0 medieval/fantasy environment models and 22 combat/life/UI audio assets, pinned to one upstream revision with per-file Git blob IDs and byte lengths.
