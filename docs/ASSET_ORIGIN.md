...
- Active runtime records must be materialized under `apps/review/public/library/`. Unmaterialized large source packs remain archival metadata and are not selectable.
...
- RINNE motion review: seven KayKit motion packs, fourteen CMU parkour BVH motions, Mesh2Motion mocap and mannequin.
