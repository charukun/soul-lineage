...
宝満叡智 peers remain the only host-eligible devices. Candidate ranking uses a deterministic capability score based on the browser information that is actually available:
