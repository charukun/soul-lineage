...
百年転生の既存本番は移行前の `prod/` を引き続き正しい公開先とする。新しい同名本番へ無断で置換しない。
...
| ゲーム | 開発 | 検証 | 本番 |
| --- | --- | --- | --- |
| 百年転生 | 200 / 登録あり | 404 / 未登録 | 200 / prod/ の旧版 |
| 喰滅廻遊 | 200 / 登録あり | 404 / 未登録 | 404 / 未登録 |
| 宝満叡智 | 200 / 登録あり | 404 / 未登録 | 404 / 未登録 |

不足は5環境。DEV公開SHAは d6c62fa401e3ceee31e37d990e2303909e3145b9、既存本番SHAは ffeec4c3e7402c619cd25dff6bff4894fb5e5709。demonのHTMLタイトルは「喰滅廻遊 | 人間狩りの夜」だったが、公開version.nameは「暗い喰らいCry」のままだった。改名PR #57は統合済みだがpackage metadataが未更新だった。
