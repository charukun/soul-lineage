...
2026-09-14。最新developを正本に、百年転生本編だけを実際に操作し、ゲームとして遊びを阻害する問題を優先順に修正する。UIの見た目だけを目的にせず、移動・生活・成長・前線・技・休息・保存再開までの一連の体験を対象にする。

## 今回の境界

- 対象: `apps/rinne` 本編、必要な本編局所テストと文書。
- 現行のLifeClock、スワイプ/フリック、自動戦闘、序破急、意識バランス、叡智豊満共有配置、保存/転生の既存仕様を優先する。
